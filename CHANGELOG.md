...
- Replaced semantic uses of the undeclared `uco-observable:DigitalService` class with the UCO 1.5.0 `uco-observable:OnlineService` class across ontology modules, SHACL constraints, examples, and tests (#46).
